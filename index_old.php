...
$select04 = "select a.quantity,b.* from product a join slider_image b on a.id = b.product_id where a.offer_price='' order by id desc";
...
?>
				                ...
				                <div class="item ">
									...
									<a href="productdetails.php?id=<?php echo $array04['product_id']; ?>">
					                	...
					                	<h6 class="pdt_price"><i class="fa fa-rupee"></i> <?php echo $array04['price']; ?></h6>
										</a>
					                	<p class="add_to_cart">
...
$select06 = "select a.id, a.name, a.quantity, a.offer_price, b.thumb_image from product a join product_image b on a.id = b.product_id where a.offer_price !='' order by a.id desc limit 0,8";
