...
{ 
	...
	$select08 = "select d.*, e.thumb_image from product d join product_image e on d.id = e.product_id where d.name like '%$keyword%' or d.brand like '%$keyword%' or d.keywords like '%$keyword%'";
} else {
	$select08 = "select d.*, e.thumb_image from main_category a join category b join sub_category c join product d join product_image e on a.id = b.main_id and b.id = c.category_id and c.id = d.subcategory_id and d.id = e.product_id where a.id = '$main_category' and (d.name like '%$keyword%' or d.brand like '%$keyword%' or d.keywords like '%$keyword%')";
}
...
<?php 
if($main_category == 'all') {
	$select07 = "select d.*, e.thumb_image from product d join product_image e on d.id = e.product_id where d.name like '%$keyword%' or d.brand like '%$keyword%' or d.keywords like '%$keyword%' LIMIT $offset, $rowsperpage";
} else {
	$select07 = "select d.*, e.thumb_image from main_category a join category b join sub_category c join product d join product_image e on a.id = b.main_id and b.id = c.category_id and c.id = d.subcategory_id and d.id = e.product_id where a.id = '$main_category' and (d.name like '%$keyword%' or d.brand like '%$keyword%' or d.keywords like '%$keyword%') LIMIT $offset, $rowsperpage";
}
