	...
	$array02 = $dbc -> fetch($query02);
     ...
     <div class="large-5 columns"> <legend>Billing Address</legend>
          <div class="form-group required large-12 columns">
            <label class="large-2 small-2 medium-2 columns control-label" for="input-firstname"> Name</label>
          ...
          <div class="form-group required large-12 columns">
            <label class="large-2 small-2 medium-2 columns control-label" for="input-email">E-Mail</label>
            <div class="large-10 small-10 medium-10 columns">
              <input type="email" name="email" value="<?php echo $array02['email']; ?>" placeholder="E-Mail" id="input-email" class="form-control">
                          </div>
          </div>
          <div class="form-group required large-12 columns">
            <label class="large-2 small-2 medium-2 columns control-label" for="input-telephone">Telephone</label>
            <div class="large-10 small-10 medium-10 columns">
          ...
          <div class="form-group required large-12 columns">
            <label class="large-2 small-2 medium-2 columns control-label" for="input-address-2">Address </label>
            <div class="large-10 small-10 medium-10 columns">
              <input type="text" name="address" value="<?php echo $array02['address']; ?>" placeholder="Address" id="input-address-2" class="form-control">
            </div>
          </div>
          <div class="form-group required large-12 columns">
            <label class="large-2 small-2 medium-2 columns control-label" for="input-city">City</label>
            <div class="large-10 small-10 medium-10 columns">
              <input type="text" name="city" value="<?php echo $array02['city']; ?>" placeholder="City" id="input-city" class="form-control">
                          </div>
          </div>
          <div class="form-group required large-12 columns">
            <label class="large-2 small-2 medium-2 columns control-label" for="input-postcode">Location</label>
            <div class="large-10 small-10 medium-10 columns">
            ...
            <label class="large-2 small-2 medium-2 columns control-label" for="input-zone">Region</label>
            <div class="large-10 small-10 medium-10 columns">
...
<?php if (empty($_SESSION['onlineuser'])) { ?>
          ...
          <div class="form-group required large-12 columns">
            <label class="large-2 small-2 medium-2 columns control-label" for="input-password">Password</label>
            <div class="large-10 small-10 medium-10 columns">
              <input type="password" name="password" value="" placeholder="Password" id="input-password" class="form-control">
                          </div>
          </div>
          <div class="form-group required large-12 columns">
            <label class="large-2 small-2 medium-2 columns control-label" for="input-confirm">Password Confirm</label>
            <div class="large-10 small-10 medium-10 columns">
