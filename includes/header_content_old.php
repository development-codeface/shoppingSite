...
<div id='cssmenu'>
 ...
 <?php } ?>
		  ...
		  <select name="category" class="cat_li_cus  large-4 small-5 medium-5  columns">
		  ...
		  <input name="search" class="large-7 small-6 medium-6 columns search_input_cus" value="<?php if(!empty($_REQUEST['search'])) echo $_REQUEST['search']; ?>" placeholder="Search..">
