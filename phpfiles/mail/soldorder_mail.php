...
<div class="container" style="border: 1px solid #ccc;">
	<div class="row">
		...
		<div class="content-bg col-md-12" style="margin-top:41px;padding-bottom: 40px;">
			...
			?>
			<span style=" font-weight: bold;font-size: 16px;color: #757575;">Hi <?php echo $name; ?> </span>, We are glad to inform that your order has been shipped. Save this e-mail for future reference. 
			</p>
