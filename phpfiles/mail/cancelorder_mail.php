...
<div class="container" style="border: 1px solid #ccc;">
	<div class="row">
		...
		<div class="content-bg col-md-12" style="margin-top:41px;padding-bottom: 40px;">
			...
			<?php
			  $name =$_REQUEST['param1'];
			  $reason =$_REQUEST['param2'];
			?>
			<span style=" font-weight: bold;font-size: 16px;color: #757575;">Hi <?php echo $name; ?> </span>, We are very sorry to inform that your order has been cancelled for the following reason. Save this e-mail for future reference. 
			</p>
			
			
			<p class="log_info" style="font-size:16px;color: #757575;"><span style="font-weight:bold;"><?php echo $reason; ?></span></p>
