...
<div class="container" style="border: 1px solid #ccc;">
	<div class="row">
		...
		<div class="content-bg col-md-12" style="margin-top:41px;padding-bottom: 40px;">
			...
			?>
			<span style=" font-weight: bold;font-size: 16px;color: #757575;">Hi  </span>, We are glad to inform that new stocks for <?php echo $name; ?> has been arrived. Save this e-mail for future reference. 
			</p>
